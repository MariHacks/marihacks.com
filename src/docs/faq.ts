...
export const faqColThree: faqCol = [
  {
    ...
    answer:
      "If you have professional experience related to MariHacks, we'd love to invite you. Judge registration will open soon, please stay tuned or send an application through the apply page!",
  },
  {
    index: 10,
    ...
    answer:
      "We'd love to have you present a workshop on any topic related to MariHacks. The panelist registration form will be open soon, feel free to send an application through the apply page!",
  },
  {
    index: 11,
    ...
    answer:
      "If you are an experienced programmer who loves to help others, we'd love to have you too! The mentor registration form will be posted soon, or you can also send an application through the apply page!",
  },
